-- UUID移行マイグレーション
-- 既存テーブルを削除して UUID ベースで再作成

DROP TABLE IF EXISTS "CeremonyParticipant" CASCADE;
DROP TABLE IF EXISTS "DankaMember" CASCADE;
DROP TABLE IF EXISTS "Ceremony" CASCADE;
DROP TABLE IF EXISTS "Danka" CASCADE;
